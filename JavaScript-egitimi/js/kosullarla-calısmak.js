// ******* KOŞULLARLA CALIŞMAK BÖLÜM SONU EGZERSİZİ *****

/*
    1- PROMPT İLE ALDIĞIN BİLGİYE GÖRE AŞAĞIDAKİ YAPIYI KULLANARAK NOTUN BİLGİSİNİ #info'ya yazdır
    ...
    2- kullanıcının girdiği verinin istedigimiz aralıkta olup olmadıgını kontrol et
    3- ff bilgisinde uzgun surat ikonu çıkart, digerlerinde ise gülücük olsun (Getbootstrap dan görsel al)
    4- ff class bilgisi text-danger, diğerleri ise text primary olsun
*/

let textInfo
let examGrade = prompt("Sınav notunu giriniz:")
